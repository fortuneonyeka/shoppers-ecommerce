    ...
    <div className='bg-gray-800 text-[#949494] font-titleFont px-4 z-50  w-[100%] h-[200px]'>
      <div className='max-w-screen-xl mx-auto grid grid-cols-2 md:flex md:flex-row py-12  justify-between'>
        ...
        <div className='flex flex-col gap-2 py-3 '>
          ...
          <p className='text-sm'>Mobile: +2348038852544</p>
          <p className='text-sm'>Email: ihedfortune@gmail.com</p>
          {/* <p className='text-xs'>Whatsapp: +2348038852544</p> */}
        </div>
        <div className='flex flex-col gap-1 py-2 cursor-pointer'>
          <h3 className='text-lg font-bold'>Profile</h3>
          <a href='/account' className='text-sm flex gap-1 items-center transition-transform duration-300 hover:scale-150 hover:text-green-200'>
            <span><TiUser /></span>
             My Account
          </a>
          <a href='/checkout' className='text-sm flex gap-1 items-center transition-transform duration-300 hover:scale-150 hover:text-green-200'>
          <span><IoBagCheckOutline /></span>
             Checkout
          </a>
          <a href='/order-tracking' className='text-sm flex gap-1 items-center transition-transform duration-300 hover:scale-150 hover:text-green-200 '>
          <span><MdSpatialTracking /></span>
            Order Tracking
          </a>
          <a href='/help-support' className='text-sm flex gap-1 items-center transition-transform duration-300 hover:scale-150 hover:text-green-200'> 
