...
const Footer = () => {
  ...
  return (
    <div className='bg-gray-800 text-[#949494] font-titleFont px-4 bottom-0 z-50 fixed w-[100%] h-[12%] '>
      <div className='max-w-screen-xl mx-auto grid grid-cols-2 gap- md:flex md:flex-row py- mb-20 justify-between'>
         
        <div className='w-10 h-10 flex flex-col gap- py-4'>
        ...
        <div className='flex flex-col py-2'>
          ...
          <form action='' className='flex gap-2 md:gap-2 md:flex-col shadow-[5px_5px_rgba(0,_98,_90,_0.4),_10px_10px_rgba(0,_98,_90,_0.3),_15px_15px_rgba(0,_98,_90,_0.2),_20px_20px_rgba(0,_98,_90,_0.1),_25px_25px_rgba(0,_98,_90,_0.05)] rounded-md'>
            <input type='email' placeholder='email' className='rounded-md py-1 px-1' />
            <button className='bg-gray-700 text-white rounded-lg hover:bg-[#17A349] hover:text-black py-1 px-4 md:px-1 focus:border-none text-md'>
              Subscribe
            </button>
          </form>
        </div>
