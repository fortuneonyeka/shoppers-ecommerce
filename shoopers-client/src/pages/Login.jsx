...
const Login = () => {
  ...
  return (
    <div className="h-screen relative">
      ...
      <div className="w-14 h-10 flex gap-20 absolute bottom-[30%] left-[45%]">
        <img src={Google} alt="google" className="rounded-xl hover:scale-125 duration-100 cursor-pointer" />

        <img src={Github} alt="github" className="rounded-xl hover:scale-125 duration-100 cursor-pointer" />
      </div>
      <div></div>
    </div>
  );
